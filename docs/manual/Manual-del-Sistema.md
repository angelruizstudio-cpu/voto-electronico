...
2. Seleccione el área correspondiente: Administrador, Moderador, Oficina, Puerta o Asambleísta.
...
1. Antes de la asamblea, confirmar que existan usuarios para Moderador, Oficina y Puerta.
...
2. Confirmar acceso de Administrador, Moderador, Oficina y Puerta.
...
3. Probar el sistema con 20 personas antes de la presentación.
4. Tener una lista impresa de credenciales como respaldo.
5. Mantener disponible un proceso manual de votación en caso de emergencia.
6. Confirmar que los dispositivos de la mesa de registro tengan buena conexión.
7. Evitar hacer cambios de configuración durante la votación.
